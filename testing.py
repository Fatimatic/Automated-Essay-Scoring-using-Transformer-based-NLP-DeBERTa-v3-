...
# Split into train/val just for evaluation
...
# ================= SHOW EXAMPLES =================
print("\nExample predictions vs actual scores:\n")
for i in range(5):  # show first 5 essays
    print(f"Essay {i+1}:")
    for j, target in enumerate(TARGETS):
        print(f" {target}: Predicted = {preds[i,j]:.2f}, Actual = {trues[i,j]:.1f}")
    print()
